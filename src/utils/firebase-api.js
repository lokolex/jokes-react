const FIREBASE_ROOT_DOMAIN = "https://react-course-http-b13db-default-rtdb.firebaseio.com";
...
export async function deleteComment(jokeId, commentId) {
  const response = await fetch(`${FIREBASE_ROOT_DOMAIN}/comments/${jokeId}/${commentId}.json`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    },
